...
<section id="ps_cashondelivery-displayOrderConfirmation">
  ...
  <div class="note">{l s='For any questions or for further information, please contact our' d='Modules.Cashondelivery.Shop'} <a href="{$contact_url}" class="link" rel="nofollow">{l s='customer support' d='Modules.Cashondelivery.Shop'}</a>.</div>
</section>
